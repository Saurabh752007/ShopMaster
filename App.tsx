...
import { AppView, ContentPage } from './types';
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-2xl shadow-gray-200/50 overflow-hidden">
              <div className="bg-sky-50/50 px-8 md:px-12 py-10 border-b border-gray-100">
                ...
                <p className="text-lg text-gray-500 font-medium max-w-2xl">
                  Everything you need to know about our business management suite and your data rights.
                </p>
              </div>
              ...
              <div className="p-8 md:p-12">
                ...
                <div className="mt-16 pt-10 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm font-black text-gray-900">Still need help?</p>
                      <p className="text-xs text-gray-400 font-bold uppercase tracking-tight">Our support team is available 24/7</p>
                    </div>
                  </div>
                  <button 
