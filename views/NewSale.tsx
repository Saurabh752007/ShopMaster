        ...
        <div className="lg:col-span-8 relative z-30">
          <div className="bg-white p-2 rounded-[2rem] border border-gray-100 shadow-sm flex items-center">
            ...
            <input 
              ...
              className="flex-1 px-4 py-4 bg-transparent font-bold outline-none text-gray-900 placeholder-gray-400"
              value={search}
            ...
            <button 
              ...
              className="p-3 bg-gray-50 rounded-[1.5rem] text-gray-400 hover:text-sky-600 hover:bg-sky-50 transition-all border border-gray-100 mr-2"
              title="Scan Barcode"
            >
